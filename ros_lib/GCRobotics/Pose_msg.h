#ifndef _ROS_GCRobotics_Pose_msg_h
#define _ROS_GCRobotics_Pose_msg_h
...
namespace GCRobotics
{
  ...
  class Pose_msg : public ros::Msg
  {
    ...
    const char * getType(){ return "GCRobotics/Pose_msg"; };
    const char * getMD5(){ return "a0c8bbbba51f36b9c247a3a067516a8a"; };
